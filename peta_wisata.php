...
<body class="bg-burlywood text-white">
  <main>
      <h1 class="text-4xl font-bold font-roboto text-black" style="text-align: center;">Objek Wisata</h1>
    ...
    <div class="grid-container">
      <?php foreach ($data as $row): ?>
        <!-- Destinasi 1 -->
        <div class="grid-item">
          <img src="<?= htmlspecialchars($row['foto']); ?>" alt="<?= htmlspecialchars($row['nama_tempat']); ?>" alt="Masjid Raya Sultan Mahmud Riayat Syah">
